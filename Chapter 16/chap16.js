...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Climb the mountain or go home";
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            if (answers[3] === "CLIMB THE MOUNTAIN") {
                story.innerHTML = document.getElementById("answer54").innerHTML;
                theEnd();
                break;
            } else if (answers[3] === "GO HOME") {
                story.innerHTML = document.getElementById("answer55").innerHTML;
                theEnd();
                break;
            } else {
                story.innerHTML = document.getElementById("err54").innerHTML;
                askQuestion(3);
                break;
            }
        default:
